...
const LodgeDetails = () => {
  ...
  useEffect(() => {
    const loadLodge = async () => {
      try {
        ...
        const foundLodge = properties.find(
          (property) =>
  ...
  const openBookingModal = () => {
    if (!user) {
      showToast("Please sign up or sign in to book a lodge tour.");
      return;
    }
    setShowModal(true);
  };
  ...
  return (
    <div className="details-container">
      ...
      <div className="details-image-wrapper">
        <img
          src={lodge.images?.[0] || "/placeholder.jpg"}
          alt={lodge.title}
      ...
      <div className="details-info">
        ...
        <div className="details-meta-grid">
          <div className="details-meta-item">
            ...
            <span className="meta-value">{lodge.state}</span>
          </div>

          <div className="details-meta-item">
            <span className="meta-label">Location</span>
            <span className="meta-value">{lodge.location}</span>
          </div>

          <div className="details-meta-item">
            <span className="meta-label">Rating</span>
            <span className="meta-value">
              <StarRating rating={lodge.rating} />
            </span>
          </div>
          ...
          <div className="chat-messages">
            {chatMessages.length === 0 && (
              <p className="chat-empty">
                👋 Hi there! Ask me anything about this lodge.
              </p>
            )}
