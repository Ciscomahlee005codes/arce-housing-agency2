...
const SharedRoomDetails = () => {
  ...
  useEffect(() => {
    const loadRooms = async () => {
      ...
      const foundRoom = properties.find(
        (property) =>
  ...
  const openBookingModal = () => {
    if (!user) {
      showToast("Please sign up or sign in to book a room tour.");
      return;
    }
    setShowModal(true);
  };
      ...
      <div className="details-info">
        ...
        <div className="details-meta-grid">
          <div className="details-meta-item">
            ...
            <span className="meta-value">{room.state}</span>
          </div>

          <div className="details-meta-item">
            <span className="meta-label">Location</span>
            <span className="meta-value">{room.location}</span>
          </div>
        ...
        <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && closeModal()}>
          <div className="modal-content">
            ...
            <p className="property-name">
              Shared Room: <span>{room.title}</span>
            </p>
